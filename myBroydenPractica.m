function [X]= myBroydenPractica(error)
clc
...
z=X0(3,1);
    ...
    J(1,1)=(((3*(x+h))-(cos(y*z))-0.5)-((3*x)-(cos(y*z))-0.5))/h;
    J(1,2)=(((3*x)-(cos((y+h)*z))-0.5)-((3*x)-(cos(y*z))-0.5))/h;
    J(1,3)=(((3*x)-(cos(y*(z+h))-0.5))-((3*x)-(cos(y*z))-0.5))/h;
    J(2,1)=((((x+h)^2)-625*(y^2))-((x^2)-625*(y^2)))/h;
    J(2,2)=(((x^2)-625*((y+h)^2))-((x^2)-625*(y^2)))/h;
    J(2,3)=0;
    J(3,1)=(((exp(-(x+h)*y))+(20*z)+(((10*pi)-3)/3))-((exp(-x*y))+(20*z)+(((10*pi)-3)/3)))/h;
    J(3,2)=(((exp(-x*(y+h)))+(20*z)+(((10*pi)-3)/3))-((exp(-x*y))+(20*z)+(((10*pi)-3)/3)))/h;
    J(3,3)=(((exp(-x*y))+(20*(z+h))+(((10*pi)-3)/3))-((exp(-x*y))+(20*z)+(((10*pi)-3)/3)))/h;
    J;
